...
class MyApp(App):
    ...
    def frin(self):
        ...
        self.BOX.add_widget(Label(size_hint=[0.1,0.1]))
        self.btn = Button(text="РАСЧЁТ", on_press = self.set_flex,background_color = '#00FFCE')
    ...
    def srin(self):
        ...
        self.boX = BoxLayout(orientation="vertical")
        self.boX.add_widget(self.plot)
        self.back = Button(text="Назад",size_hint=[1, 0.2],  on_press = self.set_back,background_color = '#00FFCE')
